...
<ul id="bbp-topic-<?php bbp_topic_id(); ?>" <?php bbp_topic_class(); ?>>
	...
	<li class="bbp-topic-voice-count"><i class="fas fa-microphone" area-hidden="true"></i><?php bbp_topic_voice_count(); ?></li>

	<li class="bbp-topic-reply-count"><i class="fas fa-comments" area-hidden="true"></i><?php bbp_show_lead_topic() ? bbp_topic_reply_count() : bbp_topic_post_count(); ?></li>
