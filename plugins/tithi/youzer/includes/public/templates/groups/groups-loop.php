				...
				<?php yz_groups_directory_group_cover( bp_get_group_id() ); ?>
					...
					<?php if ( bp_is_groups_directory() ) : ?>
						...
						<a href="<?php bp_group_permalink(); ?>" class="item-avatar">
							<?php $group_avatar = bp_core_fetch_avatar( array( 'object' => 'group', 'avatar_dir' => 'group-avatars', 'item_id' => bp_get_group_id(), 'width' => '100', 'height' => '100', 'type' => 'full', 'html' => false ) ); ?>
							<div class="yz-group-avatar" style="background-image: url(<?php echo $group_avatar; ?>)"></div>
						</a>
