	...
	<table cellspacing="0" cellpadding="0" border="0" class="desktop-table-view" >
		...
		<tr>
			...
			<td class="moon_header_paksha">
				<img src="http://www.dhoom.nl/wp-content/uploads/2018/07/state-<?php if($tithi_name=='Shukla'){echo 'shukla'; }elseif($tithi_name=='Krishna'){echo 'krishna'; } ?><?php if(strtotime($daten1)==strtotime($date3)){
				 			echo 1;
				 		...
				 		} ?>.jpg" alt="" class="moon-state-img float-right floatright" height="25" />
				<?php 
					
				 	if($tithi_name == 'Shukla') { echo 'Shukla Paksha <br>'; } else if($tithi_name == 'Krishna') { echo 'Krishna Paksha <br>'; } else { } ?>
				 	<?php 
